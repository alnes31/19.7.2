...
def test_get_api_key_for_valid_user(email=user_email, password=user_pass):
...
def test_add_new_pet_with_valid_data(name='Пёсель', animal_type='собака',
...
def test_add_new_simple_pet_with_valid_data(name='Кеша', animal_type='попугай',
                                     age='22'):
    """Проверяем что можно добавить питомца с корректными данными"""
...
def test_add_new_photo_for_pet(pet_id="", pet_photo='images\\dog.jpg'):
